...
/* ── Constraint solver — moved to attic/native/qjson_solve_ext.c on 2026-04-29.
 * Equation solving / constraint propagation belongs in the datalog repo
 * (calls qjson arithmetic primitives below). See attic/README.md. ──────── */
